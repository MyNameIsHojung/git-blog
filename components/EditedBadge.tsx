...
export default function EditedBadge({ updatedAt }: EditedBadgeProps) {
  return (
    <div className="flex items-center gap-1.5 px-3 py-1.5 bg-zinc-100 dark:bg-zinc-800 rounded-md shrink-0">
      ...
      <span className="text-xs text-zinc-500 dark:text-zinc-400">수정됨 · {formatDate(updatedAt)}</span>
    </div>
  );
}
